...
type FeedHeader struct {
	...
	Incrementality      *FeedHeader_Incrementality `protobuf:"varint,2,opt,name=incrementality,enum=transit_rt.FeedHeader_Incrementality,def=0" json:"incrementality,omitempty"`
...
type VehiclePosition struct {
	...
	CurrentStatus *VehiclePosition_VehicleStopStatus `protobuf:"varint,4,opt,name=current_status,json=currentStatus,enum=transit_rt.VehiclePosition_VehicleStopStatus,def=2" json:"current_status,omitempty"`
	// Moment at which the vehicle's position was measured. In POSIX time
	// (i.e., number of seconds since January 1st 1970 00:00:00 UTC).
	Timestamp       *uint64                          `protobuf:"varint,5,opt,name=timestamp" json:"timestamp,omitempty"`
	CongestionLevel *VehiclePosition_CongestionLevel `protobuf:"varint,6,opt,name=congestion_level,json=congestionLevel,enum=transit_rt.VehiclePosition_CongestionLevel" json:"congestion_level,omitempty"`
	// If multi_carriage_status is populated with per-carriage OccupancyStatus,
	// then this field should describe the entire vehicle with all carriages accepting passengers considered.
	OccupancyStatus *VehiclePosition_OccupancyStatus `protobuf:"varint,9,opt,name=occupancy_status,json=occupancyStatus,enum=transit_rt.VehiclePosition_OccupancyStatus" json:"occupancy_status,omitempty"`
...
type Alert struct {
	...
	Cause          *Alert_Cause      `protobuf:"varint,6,opt,name=cause,enum=transit_rt.Alert_Cause,def=1" json:"cause,omitempty"`
	Effect         *Alert_Effect     `protobuf:"varint,7,opt,name=effect,enum=transit_rt.Alert_Effect,def=8" json:"effect,omitempty"`
	...
	SeverityLevel      *Alert_SeverityLevel `protobuf:"varint,14,opt,name=severity_level,json=severityLevel,enum=transit_rt.Alert_SeverityLevel,def=1" json:"severity_level,omitempty"`
...
type TripDescriptor struct {
	...
	ScheduleRelationship *TripDescriptor_ScheduleRelationship `protobuf:"varint,4,opt,name=schedule_relationship,json=scheduleRelationship,enum=transit_rt.TripDescriptor_ScheduleRelationship" json:"schedule_relationship,omitempty"`
...
type VehicleDescriptor struct {
	...
	WheelchairAccessible *VehicleDescriptor_WheelchairAccessible `protobuf:"varint,4,opt,name=wheelchair_accessible,json=wheelchairAccessible,enum=transit_rt.VehicleDescriptor_WheelchairAccessible,def=0" json:"wheelchair_accessible,omitempty"`
	extensionFields      protoimpl.ExtensionFields
	unknownFields        protoimpl.UnknownFields
	sizeCache            protoimpl.SizeCache
}
...
type Stop struct {
	...
	WheelchairBoarding *Stop_WheelchairBoarding `protobuf:"varint,13,opt,name=wheelchair_boarding,json=wheelchairBoarding,enum=transit_rt.Stop_WheelchairBoarding,def=0" json:"wheelchair_boarding,omitempty"`
...
type TripUpdate_StopTimeUpdate struct {
	...
	DepartureOccupancyStatus *VehiclePosition_OccupancyStatus                `protobuf:"varint,7,opt,name=departure_occupancy_status,json=departureOccupancyStatus,enum=transit_rt.VehiclePosition_OccupancyStatus" json:"departure_occupancy_status,omitempty"`
	ScheduleRelationship     *TripUpdate_StopTimeUpdate_ScheduleRelationship `protobuf:"varint,5,opt,name=schedule_relationship,json=scheduleRelationship,enum=transit_rt.TripUpdate_StopTimeUpdate_ScheduleRelationship,def=0" json:"schedule_relationship,omitempty"`
...
type VehiclePosition_CarriageDetails struct {
	...
	// This message/field is still experimental, and subject to change. It may be formally adopted in the future.
	OccupancyStatus *VehiclePosition_OccupancyStatus `protobuf:"varint,3,opt,name=occupancy_status,json=occupancyStatus,enum=transit_rt.VehiclePosition_OccupancyStatus,def=7" json:"occupancy_status,omitempty"`
...
const file_proto_gtfs_realtime_proto_rawDesc = "" +
	"\n" +
	"\x19proto/gtfs-realtime.proto\x12\n" +
	"transit_rt\"}\n" +
	"\vFeedMessage\x12.\n" +
	"\x06header\x18\x01 \x02(\v2\x16.transit_rt.FeedHeaderR\x06header\x12.\n" +
	"\x06entity\x18\x02 \x03(\v2\x16.transit_rt.FeedEntityR\x06entity*\x06\b\xe8\a\x10\xd0\x0f*\x06\b\xa8F\x10\x90N\"\x81\x02\n" +
	"\n" +
	"FeedHeader\x122\n" +
	"\x15gtfs_realtime_version\x18\x01 \x02(\tR\x13gtfsRealtimeVersion\x12[\n" +
	"\x0eincrementality\x18\x02 \x01(\x0e2%.transit_rt.FeedHeader.Incrementality:\fFULL_DATASETR\x0eincrementality\x12\x1c\n" +
	"\ttimestamp\x18\x03 \x01(\x04R\ttimestamp\"4\n" +
	"\x0eIncrementality\x12\x10\n" +
	"\fFULL_DATASET\x10\x00\x12\x10\n" +
	"\fDIFFERENTIAL\x10\x01*\x06\b\xe8\a\x10\xd0\x0f*\x06\b\xa8F\x10\x90N\"\x88\x03\n" +
	"\n" +
	"FeedEntity\x12\x0e\n" +
	"\x02id\x18\x01 \x02(\tR\x02id\x12$\n" +
	"\n" +
	"is_deleted\x18\x02 \x01(\b:\x05falseR\tisDeleted\x127\n" +
	"\vtrip_update\x18\x03 \x01(\v2\x16.transit_rt.TripUpdateR\n" +
	"tripUpdate\x125\n" +
	"\avehicle\x18\x04 \x01(\v2\x1b.transit_rt.VehiclePositionR\avehicle\x12'\n" +
	"\x05alert\x18\x05 \x01(\v2\x11.transit_rt.AlertR\x05alert\x12'\n" +
	"\x05shape\x18\x06 \x01(\v2\x11.transit_rt.ShapeR\x05shape\x12$\n" +
	"\x04stop\x18\a \x01(\v2\x10.transit_rt.StopR\x04stop\x12L\n" +
	"\x12trip_modifications\x18\b \x01(\v2\x1d.transit_rt.TripModificationsR\x11tripModifications*\x06\b\xe8\a\x10\xd0\x0f*\x06\b\xa8F\x10\x90N\"\xb6\n" +
	"\n" +
	"\n" +
	"TripUpdate\x12.\n" +
	"\x04trip\x18\x01 \x02(\v2\x1a.transit_rt.TripDescriptorR\x04trip\x127\n" +
	"\avehicle\x18\x03 \x01(\v2\x1d.transit_rt.VehicleDescriptorR\avehicle\x12O\n" +
	"\x10stop_time_update\x18\x02 \x03(\v2%.transit_rt.TripUpdate.StopTimeUpdateR\x0estopTimeUpdate\x12\x1c\n" +
	"\ttimestamp\x18\x04 \x01(\x04R\ttimestamp\x12\x14\n" +
	"\x05delay\x18\x05 \x01(\x05R\x05delay\x12N\n" +
	"\x0ftrip_properties\x18\x06 \x01(\v2%.transit_rt.TripUpdate.TripPropertiesR\x0etripProperties\x1ak\n" +
	"\rStopTimeEvent\x12\x14\n" +
	"\x05delay\x18\x01 \x01(\x05R\x05delay\x12\x12\n" +
	"\x04time\x18\x02 \x01(\x03R\x04time\x12 \n" +
	"\vuncertainty\x18\x03 \x01(\x05R\vuncertainty*\x06\b\xe8\a\x10\xd0\x0f*\x06\b\xa8F\x10\x90N\x1a\xd7\x05\n" +
	"\x0eStopTimeUpdate\x12#\n" +
	"\rstop_sequence\x18\x01 \x01(\rR\fstopSequence\x12\x17\n" +
	"\astop_id\x18\x04 \x01(\tR\x06stopId\x12>\n" +
	"\aarrival\x18\x02 \x01(\v2$.transit_rt.TripUpdate.StopTimeEventR\aarrival\x12B\n" +
	"\tdeparture\x18\x03 \x01(\v2$.transit_rt.TripUpdate.StopTimeEventR\tdeparture\x12i\n" +
	"\x1adeparture_occupancy_status\x18\a \x01(\x0e2+.transit_rt.VehiclePosition.OccupancyStatusR\x18departureOccupancyStatus\x12z\n" +
	"\x15schedule_relationship\x18\x05 \x01(\x0e2:.transit_rt.TripUpdate.StopTimeUpdate.ScheduleRelationship:\tSCHEDULEDR\x14scheduleRelationship\x12j\n" +
	"\x14stop_time_properties\x18\x06 \x01(\v28.transit_rt.TripUpdate.StopTimeUpdate.StopTimePropertiesR\x12stopTimeProperties\x1aN\n" +
	...
	"\bshape_id\x18\x04 \x01(\tR\ashapeId*\x06\b\xe8\a\x10\xd0\x0f*\x06\b\xa8F\x10\x90N*\x06\b\xe8\a\x10\xd0\x0f*\x06\b\xa8F\x10\x90N\"\x8f\v\n" +
	"\x0fVehiclePosition\x12.\n" +
	"\x04trip\x18\x01 \x01(\v2\x1a.transit_rt.TripDescriptorR\x04trip\x127\n" +
	"\avehicle\x18\b \x01(\v2\x1d.transit_rt.VehicleDescriptorR\avehicle\x120\n" +
	"\bposition\x18\x02 \x01(\v2\x14.transit_rt.PositionR\bposition\x122\n" +
	"\x15current_stop_sequence\x18\x03 \x01(\rR\x13currentStopSequence\x12\x17\n" +
	"\astop_id\x18\a \x01(\tR\x06stopId\x12c\n" +
	"\x0ecurrent_status\x18\x04 \x01(\x0e2-.transit_rt.VehiclePosition.VehicleStopStatus:\rIN_TRANSIT_TOR\rcurrentStatus\x12\x1c\n" +
	"\ttimestamp\x18\x05 \x01(\x04R\ttimestamp\x12V\n" +
	"\x10congestion_level\x18\x06 \x01(\x0e2+.transit_rt.VehiclePosition.CongestionLevelR\x0fcongestionLevel\x12V\n" +
	"\x10occupancy_status\x18\t \x01(\x0e2+.transit_rt.VehiclePosition.OccupancyStatusR\x0foccupancyStatus\x121\n" +
	"\x14occupancy_percentage\x18\n" +
	" \x01(\rR\x13occupancyPercentage\x12a\n" +
	"\x16multi_carriage_details\x18\v \x03(\v2+.transit_rt.VehiclePosition.CarriageDetailsR\x14multiCarriageDetails\x1a\x96\x02\n" +
	"\x0fCarriageDetails\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x14\n" +
	"\x05label\x18\x02 \x01(\tR\x05label\x12i\n" +
	"\x10occupancy_status\x18\x03 \x01(\x0e2+.transit_rt.VehiclePosition.OccupancyStatus:\x11NO_DATA_AVAILABLER\x0foccupancyStatus\x125\n" +
	...
	"\rNOT_BOARDABLE\x10\b*\x06\b\xe8\a\x10\xd0\x0f*\x06\b\xa8F\x10\x90N\"\xd0\v\n" +
	"\x05Alert\x12:\n" +
	"\ractive_period\x18\x01 \x03(\v2\x15.transit_rt.TimeRangeR\factivePeriod\x12C\n" +
	"\x0finformed_entity\x18\x05 \x03(\v2\x1a.transit_rt.EntitySelectorR\x0einformedEntity\x12<\n" +
	"\x05cause\x18\x06 \x01(\x0e2\x17.transit_rt.Alert.Cause:\rUNKNOWN_CAUSER\x05cause\x12@\n" +
	"\x06effect\x18\a \x01(\x0e2\x18.transit_rt.Alert.Effect:\x0eUNKNOWN_EFFECTR\x06effect\x12.\n" +
	"\x03url\x18\b \x01(\v2\x1c.transit_rt.TranslatedStringR\x03url\x12=\n" +
	"\vheader_text\x18\n" +
	" \x01(\v2\x1c.transit_rt.TranslatedStringR\n" +
	"headerText\x12G\n" +
	"\x10description_text\x18\v \x01(\v2\x1c.transit_rt.TranslatedStringR\x0fdescriptionText\x12D\n" +
	"\x0ftts_header_text\x18\f \x01(\v2\x1c.transit_rt.TranslatedStringR\rttsHeaderText\x12N\n" +
	"\x14tts_description_text\x18\r \x01(\v2\x1c.transit_rt.TranslatedStringR\x12ttsDescriptionText\x12X\n" +
	"\x0eseverity_level\x18\x0e \x01(\x0e2\x1f.transit_rt.Alert.SeverityLevel:\x10UNKNOWN_SEVERITYR\rseverityLevel\x121\n" +
	"\x05image\x18\x0f \x01(\v2\x1b.transit_rt.TranslatedImageR\x05image\x12R\n" +
	"\x16image_alternative_text\x18\x10 \x01(\v2\x1c.transit_rt.TranslatedStringR\x14imageAlternativeText\x12?\n" +
	"\fcause_detail\x18\x11 \x01(\v2\x1c.transit_rt.TranslatedStringR\vcauseDetail\x12A\n" +
	"\reffect_detail\x18\x12 \x01(\v2\x1c.transit_rt.TranslatedStringR\feffectDetail\"\xd8\x01\n" +
	"\x05Cause\x12\x11\n" +
	...
	"\x05speed\x18\x05 \x01(\x02R\x05speed*\x06\b\xe8\a\x10\xd0\x0f*\x06\b\xa8F\x10\x90N\"\xe2\x04\n" +
	...
	"\n" +
	"start_date\x18\x03 \x01(\tR\tstartDate\x12d\n" +
	"\x15schedule_relationship\x18\x04 \x01(\x0e2/.transit_rt.TripDescriptor.ScheduleRelationshipR\x14scheduleRelationship\x12T\n" +
	"\rmodified_trip\x18\a \x01(\v2/.transit_rt.TripDescriptor.ModifiedTripSelectorR\fmodifiedTrip\x1ak\n" +
	"\x14ModifiedTripSelector\x12)\n" +
	"\x10modifications_id\x18\x01 \x01(\tR\x0fmodificationsId\x12(\n" +
	"\x10affected_trip_id\x18\x02 \x01(\tR\x0eaffectedTripId\"\x81\x01\n" +
	"\x14ScheduleRelationship\x12\r\n" +
	...
	"\aDELETED\x10\a*\x06\b\xe8\a\x10\xd0\x0f*\x06\b\xa8F\x10\x90N\"\xcc\x02\n" +
	"\x11VehicleDescriptor\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x14\n" +
	"\x05label\x18\x02 \x01(\tR\x05label\x12#\n" +
	"\rlicense_plate\x18\x03 \x01(\tR\flicensePlate\x12q\n" +
	"\x15wheelchair_accessible\x18\x04 \x01(\x0e22.transit_rt.VehicleDescriptor.WheelchairAccessible:\bNO_VALUER\x14wheelchairAccessible\"i\n" +
	"\x14WheelchairAccessible\x12\f\n" +
	"\bNO_VALUE\x10\x00\x12\v\n" +
	"\aUNKNOWN\x10\x01\x12\x19\n" +
	"\x15WHEELCHAIR_ACCESSIBLE\x10\x02\x12\x1b\n" +
	"\x17WHEELCHAIR_INACCESSIBLE\x10\x03*\x06\b\xe8\a\x10\xd0\x0f*\x06\b\xa8F\x10\x90N\"\xe3\x01\n" +
	...
	"\x04trip\x18\x04 \x01(\v2\x1a.transit_rt.TripDescriptorR\x04trip\x12\x17\n" +
	"\astop_id\x18\x05 \x01(\tR\x06stopId\x12!\n" +
	"\fdirection_id\x18\x06 \x01(\rR\vdirectionId*\x06\b\xe8\a\x10\xd0\x0f*\x06\b\xa8F\x10\x90N\"\xbd\x01\n" +
	"\x10TranslatedString\x12J\n" +
	"\vtranslation\x18\x01 \x03(\v2(.transit_rt.TranslatedString.TranslationR\vtranslation\x1aM\n" +
	"\vTranslation\x12\x12\n" +
	"\x04text\x18\x01 \x02(\tR\x04text\x12\x1a\n" +
	"\blanguage\x18\x02 \x01(\tR\blanguage*\x06\b\xe8\a\x10\xd0\x0f*\x06\b\xa8F\x10\x90N*\x06\b\xe8\a\x10\xd0\x0f*\x06\b\xa8F\x10\x90N\"\xe5\x01\n" +
	"\x0fTranslatedImage\x12S\n" +
	"\x0flocalized_image\x18\x01 \x03(\v2*.transit_rt.TranslatedImage.LocalizedImageR\x0elocalizedImage\x1am\n" +
	...
	"\x10encoded_polyline\x18\x02 \x01(\tR\x0fencodedPolyline*\x06\b\xe8\a\x10\xd0\x0f*\x06\b\xa8F\x10\x90N\"\xf8\x05\n" +
	"\x04Stop\x12\x17\n" +
	"\astop_id\x18\x01 \x01(\tR\x06stopId\x129\n" +
	"\tstop_code\x18\x02 \x01(\v2\x1c.transit_rt.TranslatedStringR\bstopCode\x129\n" +
	"\tstop_name\x18\x03 \x01(\v2\x1c.transit_rt.TranslatedStringR\bstopName\x12@\n" +
	"\rtts_stop_name\x18\x04 \x01(\v2\x1c.transit_rt.TranslatedStringR\vttsStopName\x129\n" +
	"\tstop_desc\x18\x05 \x01(\v2\x1c.transit_rt.TranslatedStringR\bstopDesc\x12\x19\n" +
	"\bstop_lat\x18\x06 \x01(\x02R\astopLat\x12\x19\n" +
	"\bstop_lon\x18\a \x01(\x02R\astopLon\x12\x17\n" +
	"\azone_id\x18\b \x01(\tR\x06zoneId\x127\n" +
	"\bstop_url\x18\t \x01(\v2\x1c.transit_rt.TranslatedStringR\astopUrl\x12%\n" +
	"\x0eparent_station\x18\v \x01(\tR\rparentStation\x12#\n" +
	"\rstop_timezone\x18\f \x01(\tR\fstopTimezone\x12]\n" +
	"\x13wheelchair_boarding\x18\r \x01(\x0e2#.transit_rt.Stop.WheelchairBoarding:\aUNKNOWNR\x12wheelchairBoarding\x12\x19\n" +
	"\blevel_id\x18\x0e \x01(\tR\alevelId\x12A\n" +
	"\rplatform_code\x18\x0f \x01(\v2\x1c.transit_rt.TranslatedStringR\fplatformCode\"C\n" +
	"\x12WheelchairBoarding\x12\v\n" +
	"\aUNKNOWN\x10\x00\x12\r\n" +
	"\tAVAILABLE\x10\x01\x12\x11\n" +
	"\rNOT_AVAILABLE\x10\x02*\x06\b\xe8\a\x10\xd0\x0f*\x06\b\xa8F\x10\x90N\"\x80\x06\n" +
	"\x11TripModifications\x12R\n" +
	"\x0eselected_trips\x18\x01 \x03(\v2+.transit_rt.TripModifications.SelectedTripsR\rselectedTrips\x12\x1f\n" +
	"\vstart_times\x18\x02 \x03(\tR\n" +
	"startTimes\x12#\n" +
	"\rservice_dates\x18\x03 \x03(\tR\fserviceDates\x12P\n" +
	"\rmodifications\x18\x04 \x03(\v2*.transit_rt.TripModifications.ModificationR\rmodifications\x1a\x97\x03\n" +
	"\fModification\x12H\n" +
	"\x13start_stop_selector\x18\x01 \x01(\v2\x18.transit_rt.StopSelectorR\x11startStopSelector\x12D\n" +
	"\x11end_stop_selector\x18\x02 \x01(\v2\x18.transit_rt.StopSelectorR\x0fendStopSelector\x12E\n" +
	"\x1dpropagated_modification_delay\x18\x03 \x01(\x05:\x010R\x1bpropagatedModificationDelay\x12H\n" +
	"\x11replacement_stops\x18\x04 \x03(\v2\x1b.transit_rt.ReplacementStopR\x10replacementStops\x12(\n" +
	...
	"\astop_id\x18\x02 \x01(\tR\x06stopId*\x06\b\xe8\a\x10\xd0\x0f*\x06\b\xa8F\x10\x90NBB\n" +
...
var file_proto_gtfs_realtime_proto_goTypes = []any{
	(FeedHeader_Incrementality)(0),                       // 0: transit_rt.FeedHeader.Incrementality
	(TripUpdate_StopTimeUpdate_ScheduleRelationship)(0),  // 1: transit_rt.TripUpdate.StopTimeUpdate.ScheduleRelationship
	(VehiclePosition_VehicleStopStatus)(0),               // 2: transit_rt.VehiclePosition.VehicleStopStatus
	(VehiclePosition_CongestionLevel)(0),                 // 3: transit_rt.VehiclePosition.CongestionLevel
	(VehiclePosition_OccupancyStatus)(0),                 // 4: transit_rt.VehiclePosition.OccupancyStatus
	(Alert_Cause)(0),                                     // 5: transit_rt.Alert.Cause
	(Alert_Effect)(0),                                    // 6: transit_rt.Alert.Effect
	(Alert_SeverityLevel)(0),                             // 7: transit_rt.Alert.SeverityLevel
	(TripDescriptor_ScheduleRelationship)(0),             // 8: transit_rt.TripDescriptor.ScheduleRelationship
	(VehicleDescriptor_WheelchairAccessible)(0),          // 9: transit_rt.VehicleDescriptor.WheelchairAccessible
	(Stop_WheelchairBoarding)(0),                         // 10: transit_rt.Stop.WheelchairBoarding
	(*FeedMessage)(nil),                                  // 11: transit_rt.FeedMessage
	(*FeedHeader)(nil),                                   // 12: transit_rt.FeedHeader
	(*FeedEntity)(nil),                                   // 13: transit_rt.FeedEntity
	(*TripUpdate)(nil),                                   // 14: transit_rt.TripUpdate
	(*VehiclePosition)(nil),                              // 15: transit_rt.VehiclePosition
	(*Alert)(nil),                                        // 16: transit_rt.Alert
	(*TimeRange)(nil),                                    // 17: transit_rt.TimeRange
	(*Position)(nil),                                     // 18: transit_rt.Position
	(*TripDescriptor)(nil),                               // 19: transit_rt.TripDescriptor
	(*VehicleDescriptor)(nil),                            // 20: transit_rt.VehicleDescriptor
	(*EntitySelector)(nil),                               // 21: transit_rt.EntitySelector
	(*TranslatedString)(nil),                             // 22: transit_rt.TranslatedString
	(*TranslatedImage)(nil),                              // 23: transit_rt.TranslatedImage
	(*Shape)(nil),                                        // 24: transit_rt.Shape
	(*Stop)(nil),                                         // 25: transit_rt.Stop
	(*TripModifications)(nil),                            // 26: transit_rt.TripModifications
	(*StopSelector)(nil),                                 // 27: transit_rt.StopSelector
	(*ReplacementStop)(nil),                              // 28: transit_rt.ReplacementStop
	(*TripUpdate_StopTimeEvent)(nil),                     // 29: transit_rt.TripUpdate.StopTimeEvent
	(*TripUpdate_StopTimeUpdate)(nil),                    // 30: transit_rt.TripUpdate.StopTimeUpdate
	(*TripUpdate_TripProperties)(nil),                    // 31: transit_rt.TripUpdate.TripProperties
	(*TripUpdate_StopTimeUpdate_StopTimeProperties)(nil), // 32: transit_rt.TripUpdate.StopTimeUpdate.StopTimeProperties
	(*VehiclePosition_CarriageDetails)(nil),              // 33: transit_rt.VehiclePosition.CarriageDetails
	(*TripDescriptor_ModifiedTripSelector)(nil),          // 34: transit_rt.TripDescriptor.ModifiedTripSelector
	(*TranslatedString_Translation)(nil),                 // 35: transit_rt.TranslatedString.Translation
	(*TranslatedImage_LocalizedImage)(nil),               // 36: transit_rt.TranslatedImage.LocalizedImage
	(*TripModifications_Modification)(nil),               // 37: transit_rt.TripModifications.Modification
	(*TripModifications_SelectedTrips)(nil),              // 38: transit_rt.TripModifications.SelectedTrips
}
var file_proto_gtfs_realtime_proto_depIdxs = []int32{
	12, // 0: transit_rt.FeedMessage.header:type_name -> transit_rt.FeedHeader
	13, // 1: transit_rt.FeedMessage.entity:type_name -> transit_rt.FeedEntity
	0,  // 2: transit_rt.FeedHeader.incrementality:type_name -> transit_rt.FeedHeader.Incrementality
	14, // 3: transit_rt.FeedEntity.trip_update:type_name -> transit_rt.TripUpdate
	15, // 4: transit_rt.FeedEntity.vehicle:type_name -> transit_rt.VehiclePosition
	16, // 5: transit_rt.FeedEntity.alert:type_name -> transit_rt.Alert
	24, // 6: transit_rt.FeedEntity.shape:type_name -> transit_rt.Shape
	25, // 7: transit_rt.FeedEntity.stop:type_name -> transit_rt.Stop
	26, // 8: transit_rt.FeedEntity.trip_modifications:type_name -> transit_rt.TripModifications
	19, // 9: transit_rt.TripUpdate.trip:type_name -> transit_rt.TripDescriptor
	20, // 10: transit_rt.TripUpdate.vehicle:type_name -> transit_rt.VehicleDescriptor
	30, // 11: transit_rt.TripUpdate.stop_time_update:type_name -> transit_rt.TripUpdate.StopTimeUpdate
	31, // 12: transit_rt.TripUpdate.trip_properties:type_name -> transit_rt.TripUpdate.TripProperties
	19, // 13: transit_rt.VehiclePosition.trip:type_name -> transit_rt.TripDescriptor
	20, // 14: transit_rt.VehiclePosition.vehicle:type_name -> transit_rt.VehicleDescriptor
	18, // 15: transit_rt.VehiclePosition.position:type_name -> transit_rt.Position
	2,  // 16: transit_rt.VehiclePosition.current_status:type_name -> transit_rt.VehiclePosition.VehicleStopStatus
	3,  // 17: transit_rt.VehiclePosition.congestion_level:type_name -> transit_rt.VehiclePosition.CongestionLevel
	4,  // 18: transit_rt.VehiclePosition.occupancy_status:type_name -> transit_rt.VehiclePosition.OccupancyStatus
	33, // 19: transit_rt.VehiclePosition.multi_carriage_details:type_name -> transit_rt.VehiclePosition.CarriageDetails
	17, // 20: transit_rt.Alert.active_period:type_name -> transit_rt.TimeRange
	21, // 21: transit_rt.Alert.informed_entity:type_name -> transit_rt.EntitySelector
	5,  // 22: transit_rt.Alert.cause:type_name -> transit_rt.Alert.Cause
	6,  // 23: transit_rt.Alert.effect:type_name -> transit_rt.Alert.Effect
	22, // 24: transit_rt.Alert.url:type_name -> transit_rt.TranslatedString
	22, // 25: transit_rt.Alert.header_text:type_name -> transit_rt.TranslatedString
	22, // 26: transit_rt.Alert.description_text:type_name -> transit_rt.TranslatedString
	22, // 27: transit_rt.Alert.tts_header_text:type_name -> transit_rt.TranslatedString
	22, // 28: transit_rt.Alert.tts_description_text:type_name -> transit_rt.TranslatedString
	7,  // 29: transit_rt.Alert.severity_level:type_name -> transit_rt.Alert.SeverityLevel
	23, // 30: transit_rt.Alert.image:type_name -> transit_rt.TranslatedImage
	22, // 31: transit_rt.Alert.image_alternative_text:type_name -> transit_rt.TranslatedString
	22, // 32: transit_rt.Alert.cause_detail:type_name -> transit_rt.TranslatedString
	22, // 33: transit_rt.Alert.effect_detail:type_name -> transit_rt.TranslatedString
	8,  // 34: transit_rt.TripDescriptor.schedule_relationship:type_name -> transit_rt.TripDescriptor.ScheduleRelationship
	34, // 35: transit_rt.TripDescriptor.modified_trip:type_name -> transit_rt.TripDescriptor.ModifiedTripSelector
	9,  // 36: transit_rt.VehicleDescriptor.wheelchair_accessible:type_name -> transit_rt.VehicleDescriptor.WheelchairAccessible
	19, // 37: transit_rt.EntitySelector.trip:type_name -> transit_rt.TripDescriptor
	35, // 38: transit_rt.TranslatedString.translation:type_name -> transit_rt.TranslatedString.Translation
	36, // 39: transit_rt.TranslatedImage.localized_image:type_name -> transit_rt.TranslatedImage.LocalizedImage
	22, // 40: transit_rt.Stop.stop_code:type_name -> transit_rt.TranslatedString
	22, // 41: transit_rt.Stop.stop_name:type_name -> transit_rt.TranslatedString
	22, // 42: transit_rt.Stop.tts_stop_name:type_name -> transit_rt.TranslatedString
	22, // 43: transit_rt.Stop.stop_desc:type_name -> transit_rt.TranslatedString
	22, // 44: transit_rt.Stop.stop_url:type_name -> transit_rt.TranslatedString
	10, // 45: transit_rt.Stop.wheelchair_boarding:type_name -> transit_rt.Stop.WheelchairBoarding
	22, // 46: transit_rt.Stop.platform_code:type_name -> transit_rt.TranslatedString
	38, // 47: transit_rt.TripModifications.selected_trips:type_name -> transit_rt.TripModifications.SelectedTrips
	37, // 48: transit_rt.TripModifications.modifications:type_name -> transit_rt.TripModifications.Modification
	29, // 49: transit_rt.TripUpdate.StopTimeUpdate.arrival:type_name -> transit_rt.TripUpdate.StopTimeEvent
	29, // 50: transit_rt.TripUpdate.StopTimeUpdate.departure:type_name -> transit_rt.TripUpdate.StopTimeEvent
	4,  // 51: transit_rt.TripUpdate.StopTimeUpdate.departure_occupancy_status:type_name -> transit_rt.VehiclePosition.OccupancyStatus
	1,  // 52: transit_rt.TripUpdate.StopTimeUpdate.schedule_relationship:type_name -> transit_rt.TripUpdate.StopTimeUpdate.ScheduleRelationship
	32, // 53: transit_rt.TripUpdate.StopTimeUpdate.stop_time_properties:type_name -> transit_rt.TripUpdate.StopTimeUpdate.StopTimeProperties
	4,  // 54: transit_rt.VehiclePosition.CarriageDetails.occupancy_status:type_name -> transit_rt.VehiclePosition.OccupancyStatus
	27, // 55: transit_rt.TripModifications.Modification.start_stop_selector:type_name -> transit_rt.StopSelector
	27, // 56: transit_rt.TripModifications.Modification.end_stop_selector:type_name -> transit_rt.StopSelector
	28, // 57: transit_rt.TripModifications.Modification.replacement_stops:type_name -> transit_rt.ReplacementStop
